...
- Early on apparently, a 'hacker' with a computer in a DC musuem uses JD's face as a profile photo, too, and kept communicating with BotSentinel. 
- When McGowan's credit history was removed, it was stated it could likely be an insider in FinTech. It also felt like chats could be synced to cause fear of commmunications with her. Pellicano - related to Paul Barresi who is attacking Amber Heard by exploiting generational ignorance -'s history mentions <a href="https://en.wikipedia.org/wiki/Anthony_Pellicano#cite_note-Resentence-20">software</a> early on. The point is, since Nov 2019, it's been suspicious of infiltration.
