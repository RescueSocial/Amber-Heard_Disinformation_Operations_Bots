...
df_pos = df_tweets[df_tweets.text.str.contains('|'.join(pos_text))]
...
df_threat = df_tweets[df_tweets.text.str.contains('|'.join(all_threat))]
...
df_hate = df_tweets[df_tweets.text.str.contains('|'.join(neg_text))]
...
threat_dict = count_keywords(threat_keys, df_tweets)
