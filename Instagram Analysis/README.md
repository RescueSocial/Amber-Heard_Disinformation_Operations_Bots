...
- Instagram has features which make using bot accounts very difficult, which explains the far less volume of data against Amber Heard under her hashtag, and explains more of why on Instagram they focused more on her ex-partner. The higher positivity towards Amber Heard under her name on Instagram reflects more of the real-world. E.g., our researcher had to use 10 proxies with 10 different accounts which would frequently be blocked, unlike Twitter with 1 proxy, 1 IP (never discovered our monitoring bot either), Google, Reddit, and other platforms with far higher volume of bots and API access.
